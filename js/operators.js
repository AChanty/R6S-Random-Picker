export const attackers = [
   {
      name: 'Ace',
      image: 'img/op-portraits/ace.webp',
      icon: 'img/op-icons/ace.svg',
   },
   {
      name: 'Amaru',
      image: 'img/op-portraits/amaru.webp',
      icon: 'img/op-icons/amaru.svg',
   },
   {
      name: 'Ash',
   ...
   {
      name: 'IQ',
      image: 'img/op-portraits/iq.webp',
      icon: 'img/op-icons/iq.svg',
   },
   {
      name: 'Jackal',
...
export const allOps = attackers.concat(defenders) // merge les deux tableaux en un seul
